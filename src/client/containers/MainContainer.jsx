  ...
  return (
    <div id="mainContainer">
      ...
      <div className="mainContainerDiv">
        ...
        <br />
        <br />
        <img id="dbView" className="example-image" src={dbViewImgUrl} onClick={event => openModalDisplay(event)} />
        <br />
        <br />
        <span className="mainSpan">
        ...
        <br />
        <br />
        <img id="dbDiff" className="example-image" src={dbDiffImgUrl} onClick={event => openModalDisplay(event)} />
      </div>
    </div>
  );
};
